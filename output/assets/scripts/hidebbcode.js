...
{ 
   ...
   s += '<div class="spoiler-link"><a href="javascript:hideBBCode.showHide(\'' + randomId + '\');" onmouseover="top.status=\'\';" onfocus="this.blur();">' + l_hide + '</a></div>'; 
   s += '<div class="spoiler" id="' + randomId + '" style="'+style+'">'; 
   document.write(s); 
